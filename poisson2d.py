...
# run with /Users/bricelecampion/petsc-hash-pkgs/a7c066/bin/mpiexec -n 4 python ...
# i.e. use the mpiexec corresponding to the petsc / petsc4py built
